...
public class Main {
    public static void main(String[] args) {
        ...
        String kredi2 = "Mutlu Eemekli Kredisi";
        ...
        String[] krediler = {"Hızlı Kredi", "Mutlu Eemekli Kredisi", "Konut Kredisi", "Çiftçi Kredisi", "MSB Kredisi", "MEB Kredisi", "Kültür Bakanlığı Kredisi"};
